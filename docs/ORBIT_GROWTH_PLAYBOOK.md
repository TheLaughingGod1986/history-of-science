...
- black holes
- exoplanets
- strange stars / discoveries
- cosmic scale / existential questions
- telescopes & major discoveries (JWST-class)
- civilisation / future humanity (careful, non-fearbait)

Avoid: generic science news churn, conspiracy framing, trend-chasing outside brand.

---

## Shorts — narrative framework (canonical)

**Default duration: 22–30 seconds.**  
Prefer concise. Do not stretch a 20s idea to 45–60s. Longer only if the story earns it.
...
Before each Short, write **≥5 hooks**. Classify:

1. Curiosity  
2. Contradiction  
3. Scale  
4. Fear / danger (wonder-first; no fearbait titles)  
5. Discovery  
6. Unanswered mystery  
...
| Metric | Current (early) | Initial target | Strong |
|--------|-----------------|----------------|--------|
| Stayed to watch | ~20% | 35%+ | 50%+ |
| Avg % viewed (~22–30s) | ~44–51% | 70%+ | 85%+ |
| Completion | ~21% | 45%+ | — |
| Subs / 1k views | ~0 | 5–15 | — |

Tiny samples: directional only. Do not pivot niche on &lt;1k views.
...
Template: `00_Brand/Channel-Setup/templates/TOPIC_OPPORTUNITY_SCORE.md`
