...
## Snapshot — 2026-08-25 (channel 29 days)

**4 subs · 949 views · 27 videos** (vidIQ). Public longs ~**34** combined views. Public Shorts we can count ~**870**. Full write-up: `00_Brand/Channel-Setup/audits/CHANNEL_AUDIT_2026-08-25/CHANNEL_AUDIT.md`.

| Pattern | Evidence | Learning |
|---------|----------|----------|
| Shorts still the only engine | Shelf leaders 63–141 views vs longs 4–10 | Do not pivot. Do not recut longs for views. Ship 7–9 min + punch Shorts. |
| Title formula holds | Three Suns 141 · Universe Gives Off No Light 122 · JWST textbook 83 · Diamond 63 | S1–S6 only. Kill abstract / superlative-without-picture. |
...
| 21-min catalogue is not the template | Fermi 18:32 · BH 21:13 · AW 21:29 · JWST 16:33, all cold | Next films stay **7–9 min** (Neutron v02 is 8.89). |
| Indexes lie | 001–003 still name deleted IDs | Rewrite to live IDs after every replace. Search `forMine`, not Uploads only. |

Analytics CTR / APV / retention curves **not pulled** this night (vidIQ credits + YouTube API quota). Do not invent them.
...
| Date | Source | Note |
|------|--------|------|
| 2026-08-25 | vidIQ stats + RSS + scrape | 4 subs / 949 views; Shorts>>longs; title formula confirmed; indexes stale |
