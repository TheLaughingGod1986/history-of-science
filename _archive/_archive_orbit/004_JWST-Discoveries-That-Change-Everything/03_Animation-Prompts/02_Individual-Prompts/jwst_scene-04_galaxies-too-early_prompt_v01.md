...
### A — arrive at luminous early galaxy (8–10s)

--- PROMPT ---

Premium cinematic 3D animation, educational space documentary. Soft warm key light on Orbit, cool scientific accents, shallow depth of field, continuous subtle hover. Full character motion — not a still with light wiggle. SILENT PICTURE ONLY: no dialogue, no narration, no voiceover, no spoken words, no lip-sync speech, no American or any-language talking. Ambient space only if audio is required; otherwise mute. Channel VO is British Ben Orbit Narrator mixed in edit.

Deep field. A luminous compact early galaxy shining against dark space. Orbit tiny nearby, facing it, cream eyes stunned. No UFO tropes. Cinematic cosmic dawn light.
...
### B — brightness meter awe (8–10s)

--- PROMPT ---

Premium cinematic 3D animation, educational space documentary. Soft warm key light on Orbit, cool scientific accents, shallow depth of field, continuous subtle hover. Full character motion — not a still with light wiggle. SILENT PICTURE ONLY: no dialogue, no narration, no voiceover, no spoken words, no lip-sync speech, no American or any-language talking. Ambient space only if audio is required; otherwise mute. Channel VO is British Ben Orbit Narrator mixed in edit.

Orbit carefully measures brightness with a soft holographic meter (no readable numbers/text — abstract glowing bars only). Cream eyes wide. Galaxy luminous behind. Continuous hover.
...
### C — write hypotheses (8–10s)

--- PROMPT ---

Premium cinematic 3D animation, educational space documentary. Soft warm key light on Orbit, cool scientific accents, shallow depth of field, continuous subtle hover. Full character motion — not a still with light wiggle. SILENT PICTURE ONLY: no dialogue, no narration, no voiceover, no spoken words, no lip-sync speech, no American or any-language talking. Ambient space only if audio is required; otherwise mute. Channel VO is British Ben Orbit Narrator mixed in edit.

Orbit writes floating abstract hypothesis glyphs (no English letters). Crosses none out. Thoughtful bob. Early galaxy soft in background. Wonder without panic.
