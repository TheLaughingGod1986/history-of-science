#!/usr/bin/env python3
"""Bold Explainer v11 — upload-ready, no-repeat picture and audible sound mix.
...
Adds:
  ...
  - Hook-first animated Orbit brand introduction
...
OUT = ROOT / "09_Final-Export/aliens_BOLD_EXPLAINER_v11_UPLOAD_READY_MASTER.mp4"
PROOF = ROOT / "09_Final-Export/aliens_v11_PROOF_hook_intro_60s.mp4"
CHAPTER_PROOF = ROOT / "09_Final-Export/aliens_v11_PROOF_stable_cards_45s.mp4"
MANIFEST = ROOT / "07_Edit-Project/bold-explainer-v11-upload-ready-timeline.json"
...
def main() -> None:
    ...
    manifest = {
        "version": "bold-explainer-v11-upload-ready",
