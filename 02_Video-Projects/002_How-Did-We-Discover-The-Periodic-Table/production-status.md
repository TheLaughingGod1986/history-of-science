...
| Gate | Script **PASS** (90.4) |
| Affiliate | none |
| Not | Orbit Omni · Oppti · Neutron Star · Moon Leaving (waits) |
...
| `00_Brand/Brand-Guidelines/HOS_UAT_BIBLE_HOUSE_LOCK.md` | Standing ALWAYS UAT bible — consistency · VO visual explainer · Explorer round glasses · lamp clean warm glow · readable cards / no garbled · Explorer face/hair finished · no lamp lava drip · late-shot sharp (no horizontal ghosts; continuous playback) (every HOS cut) |
...
- Blue / cyan scrub mask
- Orange embers / fire
- Clear flask by the scale
- Ken Burns
- Orbit robot
...
### P03 house locks (see `PART03_LESSONS.md`)
...
Clearer educational scripts · VO + picture sync · any-age friendly · teach chemistry **and** why the discovery mattered. House lock: `00_Brand/Brand-Guidelines/HOS_HOUSE_VO_AND_TEACH_LOCK.md` (Part 04+). Also `PART03_LESSONS.md`.
