...
## Studio (plate-library) — Ben LOCK

1. Plate library / KEEP DNA per beat; lamp framing with **NO visible underside bulb / shade cup**.
2. Plate-first: **no** `rough_vN` assemble until this reminted plate clears continuous-playback plate UAT.
...
6. One plate per FAIL cycle until that plate KEEP; then next plate; assemble last.
