"""Assemble HOS 002 Part 04 rough v14 — CLEAN GLOW remint of 09b only.
...
OUT = PROJ / "09_Final-Export/hos_002_part04_rough_v14.mp4"
...
REMINT_V14_IDS = {
    "09b_risk_hold",  # ONLY — chair-top flame @ ~105s
}
KEEP_V13_IDS = {
...
def resolve_clip(pid: str) -> tuple[Path, str]:
    if pid in REMINT_V14_IDS:
        v14 = RAW_V14 / f"{pid}_v14.mp4"
        if v14.exists() and v14.stat().st_size >= 400_000:
            return v14, "v14_clean_glow"
        raise SystemExit(f"missing reminted v14 plate {v14}")
...
def main() -> None:
    ...
    dur = probe(OUT)
    reminted = [pid for pid, src in zip(ordered_ids, sources) if src == "v14_clean_glow"]
    ...
    meta_path = PROJ / "07_Edit-Project/part04_rough_v14_land_meta.json"
        ...
        json.dumps(
            {
                ...
                "duration_s": dur,
                "sha256": digest,
                "parent_v13": KEEP_V13_PARENT.name,
                ...
                "watch": "WATCH_part04_v14.txt",
                "doc": "PART04_V14_PLATE10_CLEAN_GLOW.md",
                "status": (
    ...
    watch = ICLOUD / "WATCH_part04_v14.txt"
    watch.write_text(
    ...
    (PROJ / "07_Edit-Project/WATCH_part04_v14.txt").write_text(watch.read_text())
    ...
    (ICLOUD / "PART04_NEXT.txt").write_text(
        ...
        "Watch WATCH_part04_v14.txt · PART04_V14_PLATE10_CLEAN_GLOW.md\n"
        "Scores → CoS. Do not declare PASS. Do not ping Ben.\n"
    )
