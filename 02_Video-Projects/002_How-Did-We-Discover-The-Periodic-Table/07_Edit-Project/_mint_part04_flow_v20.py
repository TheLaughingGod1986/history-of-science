...
PROMPTS = {
    ...
    "09b_risk_hold": (
        ...
        "bookshelf, moon in the window, ceramic vessels on the desk. LOCKED TRIPOD CAMERA. Silent. "
        "CLEAN LIGHT — HOUSE HARD FAIL IF BROKEN for the FULL 8 seconds (try8 UAT FAIL was lamp lava drip): "
        "warm clean desk-lamp glow ONLY. The opaque lampshade HIDES the bulb — soft continuous warm cone, "
        "NO hanging teardrop of light under the shade rim. "
        "HARD BAN forever (t0 through t8): lava drip, molten teardrop, molten bead, fire spit, sparks, "
        ...
        "any glowing droplet / goo / spit hanging under the lamp shade or falling onto the desk. "
        "Soft Empty Chairs panel OK (one soft rectangular glow on/near the chair). "
        "Do NOT invent flat H/C/O/N element cards, letter tiles, HUD chips, or unfinished flat overlays. "
