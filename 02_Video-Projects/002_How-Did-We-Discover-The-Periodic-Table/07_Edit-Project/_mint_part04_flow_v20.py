...
PROMPTS = {
    ...
    "09b_risk_hold": (
        ...
        "(try8 UAT + try9A SELF_REJECT: lamp lava drip / molten teardrop under shade): "
        "warm clean desk-lamp glow ONLY as a soft continuous pool of light on the desk. "
        "OPAQUE metal lampshade fully covers and HIDES the bulb — underside of shade is a DARK MATTE cavity. "
        "NO visible glass bulb, NO bright point under the rim, NO hanging teardrop / molten bead / lava drip "
        "under the shade, NO fire spit, NO sparks on the desk. "
