#!/usr/bin/env python3
"""Assemble HOS 002 Part 04 rough v22 — KEEP remints locked (assemble unlock).

Parent: hos_002_part04_rough_v20.mp4
  sha256 1cd8249ad635b5f8339dc5fb155c9483c090ea4c6969efab19572ffa14d6d45b

CoS 10 Sep 2026: reminted plate library UAT KEEP. Unlock assemble.
Swap ONLY six KEEP remints into the v20 plate map; no further remints this cycle.
NO PAINT on reminted picture. Scores → CoS. Do not declare PASS. Do not ping Ben.
"""
...
OUT = PROJ / "09_Final-Export/hos_002_part04_rough_v22.mp4"
...
KEEP_REMINTS: dict[str, tuple[Path, str]] = {
    ...
    "06_explorer_leaves_gap": (
        RAW_V20 / "06_explorer_leaves_gap_v20_try3.mp4",
        "df9bb44fb123e1a737976517be0dc809470f1828f1dba0dc8f1178f59721978c",
    ),
    "09b_risk_hold": (
...
def main() -> None:
    ...
    meta_path = PROJ / "07_Edit-Project/part04_rough_v22_land_meta.json"
        ...
        json.dumps(
            {
                ...
                "watch": "WATCH_part04_v22.txt",
                "doc": "PART04_ASSEMBLE_V22.md",
                "status": (
    ...
    watch_body = (
        "WATCH THIS FILE ONLY (Part 04 rough v22 — KEEP remints assemble):\n"
        f"  {OUT.name}\n\n"
        "CoS / Picture→UAT gates for this cut:\n"
        "- Plate-library LOCKED. Reminted plates UAT KEEP. No more remints this cycle.\n"
        "- KEEP remints swapped into v20 map:\n"
        "  · 05_columns_families try2B Quality sha 49437e7e…e8caa (lava remint)\n"
        "  · 06_explorer_leaves_gap try3 sha df9bb44f…1978c\n"
        "  · 09b_risk_hold try14 Quality sha 47a6bdeb…44c38\n"
        "  · 10_family_before_weight try1A Quality sha 49240cbb…81b78 (lava remint)\n"
        "  · 11_publish_gaps try9 sha 97d0c419…8cc72\n"
        "  · 11b_wait_and_hunt try1 sha 5602762e…3075e\n"
        "- UAT scrub: no lava drip ~t38–43 (PERIODIC TABLE) / ~t108 (FAMILY FIRST)\n"
        "- NO PAINT FALLBACK on reminted picture.\n"
        "- Animistry side labels + VO + curious workshop bed.\n"
        "- Spot EMPTY SEATS / A BET hold / PUBLISH — no 5–10s lag regressions.\n"
        "- Part 01–03 LOCKED. Do NOT declare PASS here. Scores → CoS. No Ben ping.\n\n"
...
f"plate10_sha256={plate_sha.get('10_family_before_weight')}\n"
    ...
    watch = ICLOUD / "WATCH_part04_v22.txt"
    watch.write_text(watch_body)
    (PROJ / "07_Edit-Project/WATCH_part04_v22.txt").write_text(watch_body)
    (ICLOUD / "ZZ_OPEN_PART04_V22_ONLY.txt").write_text(
        "Part 04 current cut = hos_002_part04_rough_v22.mp4\n"
        "Part 01–03 LOCKED keepers.\n"
        "v20 remint map + six UAT KEEP remints (lava 05+10) — watch v22 only.\n"
    )
    (ICLOUD / "PART04_NEXT.txt").write_text(
        "Part 04 rough assemble LANDED: hos_002_part04_rough_v22.mp4\n"
        "Watch WATCH_part04_v22.txt · PART04_ASSEMBLE_V22.md\n"
