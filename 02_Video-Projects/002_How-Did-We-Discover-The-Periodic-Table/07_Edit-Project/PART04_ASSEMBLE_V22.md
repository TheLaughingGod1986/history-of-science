# P04 Empty Chairs — ASSEMBLE UNLOCK → `hos_002_part04_rough_v22`

**Showrunner 10 Sep 2026 evening burn:** plate **10** KEEP confirmed. **GREEN Mini assemble now.**  
**Rough version:** `hos_002_part04_rough_v22.mp4`  
**Parent picture pack:** v21 assemble map + swap in lava-desk remints below (`05` KEEP + `10` KEEP).  
...
| `10_family_before_weight` | `04_Generated-Clips/part04/raw/v22_quality/10_family_before_weight_v22_try1.mp4` | `49240cbb4fab760e710f24051d822c61f0b8c1236684fc697016db325ab81b78` | **KEEP** (try1A BOARDTOP Quality) |
...
STOP if any sha mismatches. All lava-desk remints + prior KEEP hold are filled. KEEP set: 05 · 06 · 09b · 10 · 11 · 11b.
...
- **UNLOCKED** — plate `10` KEEP confirmed; assemble now.  
