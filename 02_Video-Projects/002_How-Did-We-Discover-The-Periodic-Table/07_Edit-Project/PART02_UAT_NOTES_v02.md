...
- Replaced Flow gibberish cards / flaming-pot workshops (plates **02–11**) with **local Pillow cards**: exact English, factual copy aligned to VO.
- Plate **01** chapter card kept (`CHAPTER 2 / HISTORY of SCIENCE`).
...
- Do **not** start Part 03 until PASS.
