#!/usr/bin/env python3
"""ONE-SHOT remint Part 01 plate 10 — Flow Veo I2V (Lite OK).
...
START = PROJ / "07_Edit-Project/_qa_v13_plate10_prep/plate10_start_v13_colourless_shimmer.jpg"
...
PROMPT = (
    ...
    "History of Science locked look: premium Animistry-class 3D cartoon, warm cinematic light. "
    "Not photoreal. Silent. No readable text. No Orbit robot. Continuous gentle camera drift "
    "the whole clip — never a still freeze, never Ken Burns zoom on a freeze-frame. "
...
def main() -> None:
    ...
    print(f"Flow I2V plate10 v13 model={MODEL} profile={profile}", flush=True)
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            ctx.close()
    print("OK plate10 v13 I2V remint finished", flush=True)
