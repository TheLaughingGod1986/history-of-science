#!/usr/bin/env python3
"""Force-download finished Flow mp4 from Part 03 v07 project (net-capture resilient)."""
...
PROJ = "https://flow.google.com/u/1/project/f342b44a-4c5d-4907-b9a3-d8bbd0c40c30"
DEST = (
    Path(__file__).resolve().parents[1]
    / "04_Generated-Clips/part03/raw/v07_fast/03_method_pamphlet_v07.mp4"
)
...
def main() -> None:
    ...
    with sync_playwright() as p:
        ...
        try:
            page.goto(PROJ, wait_until="domcontentloaded", timeout=120_000)
            ...
            if got and accept_mp4(tmp):
                raise SystemExit(0)

            # Manual Download media + net_hits (same pattern as successful v06)
            net_hits: list[bytes] = []
