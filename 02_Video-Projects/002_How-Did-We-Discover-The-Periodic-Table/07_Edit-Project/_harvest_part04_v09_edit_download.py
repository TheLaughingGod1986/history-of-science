#!/usr/bin/env python3
"""Download Part04 v09 plate 06 from a known Flow project (no Facebook pollution).
...
def main() -> None:
    ...
    ap.add_argument(
        ...
        default=Path(
            ...
            "04_Generated-Clips/part04/raw/v09_fast/"
            "06_explorer_leaves_gap_v09.try2.tmp.mp4"
        ),
    )
    args = ap.parse_args()
    dest = args.dest
