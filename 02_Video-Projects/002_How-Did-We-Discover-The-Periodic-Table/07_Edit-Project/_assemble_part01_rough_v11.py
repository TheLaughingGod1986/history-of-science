#!/usr/bin/env python3
"""Assemble HOS 002 Part 01 v11 — v10 plate10 remint — no flask, ore in pan, heat shimmer: 05 opaque jar · 10 no-flames · 11/12 opaque + audible workshop bed → HOS UAT only."""
...
OUT = PROJ / "09_Final-Export/hos_002_part01_rough_v11.mp4"
