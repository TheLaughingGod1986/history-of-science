#!/usr/bin/env python3
"""Force-download Part 03 v09 plate 10 from Flow project (Download media path)."""
...
PROJECT = "https://flow.google.com/u/1/project/1b59e77e-77b2-46fd-b5d4-d17c3107eb0b"
DEST = (
    Path(__file__).resolve().parents[1]
    / "04_Generated-Clips/part03/raw/v09_fast/10_city_plan_lots_v09.mp4"
)
...
def main() -> None:
    ...
    with sync_playwright() as p:
        ...
        # Ensure downloads land somewhere we control
        dl_dir = dest.parent / "_flow_downloads"
        ...
        try:
            ...
            for i in range(60):
                ...
                if "generating" in body or "%" in body[:500]:
                    # still may be fine if thumbs exist
                    pass
            ...
            # Try play to trigger network mp4
            ...
            try:
                ...
                dl = di.value
                raw = None
                # Keep page alive; prefer suggested path via failure-safe save
