#!/usr/bin/env python3
"""Assemble HOS 002 Part 04 rough v21 — KEEP remints locked (assemble unlock).
...
Swap ONLY four KEEP remints into the v20 plate map; no further remints this cycle.
...
OUT = PROJ / "09_Final-Export/hos_002_part04_rough_v21.mp4"
...
def resolve_clip(pid: str) -> tuple[Path, str]:
    if pid in KEEP_REMINTS:
        ...
        return clip, "v21_keep_remint_uat"
...
def main() -> None:
    ...
    dur = probe(OUT)
    keep_swapped = [pid for pid, src in zip(ordered_ids, sources) if src == "v21_keep_remint_uat"]
    ...
    meta_path = PROJ / "07_Edit-Project/part04_rough_v21_land_meta.json"
        ...
        json.dumps(
            {
                ...
                "watch": "WATCH_part04_v21.txt",
                "doc": "PART04_ASSEMBLE_V21.md",
                "status": (
    ...
    watch_body = (
        "WATCH THIS FILE ONLY (Part 04 rough v21 — KEEP remints assemble):\n"
        f"  {OUT.name}\n\n"
        ...
        "  · 11_publish_gaps try9 sha 97d0c419…f8cc72\n"
    ...
    watch = ICLOUD / "WATCH_part04_v21.txt"
    watch.write_text(watch_body)
    (PROJ / "07_Edit-Project/WATCH_part04_v21.txt").write_text(watch_body)
    (ICLOUD / "ZZ_OPEN_PART04_V21_ONLY.txt").write_text(
        "Part 04 current cut = hos_002_part04_rough_v21.mp4\n"
        "Part 01–03 LOCKED keepers.\n"
        "v20 remint map + four UAT KEEP remints — watch v21 only.\n"
    )
    (ICLOUD / "PART04_NEXT.txt").write_text(
        "Part 04 rough assemble LANDED: hos_002_part04_rough_v21.mp4\n"
        "Watch WATCH_part04_v21.txt · PART04_ASSEMBLE_V21.md\n"
