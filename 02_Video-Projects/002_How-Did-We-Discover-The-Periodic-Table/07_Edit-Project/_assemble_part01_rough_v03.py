#!/usr/bin/env python3
"""Assemble HOS 002 Part 01 rough v03 — unique Flow plates + locked VO."""
...
OUT = PROJ / "09_Final-Export/hos_002_part01_rough_v03.mp4"
CLIP_USE = 8.0
XFADE = 0.4
...
def main() -> None:
    ...
    print(f"assemble v03 → {OUT.name} vo={vo_dur:.2f}s", flush=True)
