#!/usr/bin/env python3
"""Assemble HOS 002 Part 01 rough v14 — plate 10 blue-scrub clear + Animistry side labels."""
...
OUT = PROJ / "09_Final-Export/hos_002_part01_rough_v14.mp4"
...
def main() -> None:
    ...
    watch = ICLOUD / "WATCH_part01_v14.txt"
    watch.write_text(
        "WATCH THIS FILE ONLY (Part 01 remint rough v14):\n"
        f"  {OUT.name}\n\n"
        ...
        "- Plate 10: colourless shimmer under grate (NO orange/fire/embers)\n- Plate 10: NO blue rectangular scrub/mask around ore\n- KEEP: ore IN brass pan · Animistry side labels · no flask beside scale\n"
    ...
    (ICLOUD / "ZZ_OPEN_PART01_V13.txt").write_text(
        "Part 01 current remint cut = hos_002_part01_rough_v14.mp4\n"
