#!/usr/bin/env python3
"""Assemble HOS 002 Part 01 rough v12 — real Veo + Animistry side labels."""
...
OUT = PROJ / "09_Final-Export/hos_002_part01_rough_v12.mp4"
...
def main() -> None:
    ...
    watch = ICLOUD / "WATCH_part01_v12.txt"
    watch.write_text(
        "WATCH THIS FILE ONLY (Part 01 remint rough v12):\n"
        f"  {OUT.name}\n\n"
        ...
        "- Plate 10 HOLD: ore IN brass pan · shimmer only · no clear flask\n"
        "- Explorer once · British VO · 3D cartoon\n\n"
        "Do not ping Ben. Reject with stills from THIS file only.\n"
        f"sha256={digest}\n"
    )
    (ICLOUD / "ZZ_OPEN_PART01_V12.txt").write_text(
        "Part 01 current remint cut = hos_002_part01_rough_v12.mp4\n"
        "Prior v11 superseded in this folder.\n"
    )
