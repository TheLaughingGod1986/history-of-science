#!/usr/bin/env python3
"""Part 01 v19 — keep v18 hook wav; repair knives including the s.

Source picture: v16. Knives take: v09 VO stem (same as v08). Do not remint.
"""
...
# v09 broadcast take at 48 kHz (not the 16 kHz ASR stem). Same VO as v08.
VO = PROJ / "09_Final-Export/hos_001_part01_rough_v09.mp4"
HOOK = PROJ / "02_Voiceover/part01_shadow_hook_v01.wav"
BED = PROJ / "05_Music/hos_001_part01_ominous_ward_v14_norm.wav"
OUT = PROJ / "09_Final-Export/hos_001_part01_rough_v19.mp4"
ART = Path(
...
V16_OUT = 75.208
# Vowel 75.62–76.05; sibilant s 76.12–76.25; decayed by 76.30.
KNIVES_IN = 75.620
KNIVES_OUT = 76.300
BREATH = 0.20
HOOK_DUR = 3.44
...
def main() -> None:
    ...
    print(f"VO_TAKE v09_decoded_stem", flush=True)
    print(f"KNIVES {KNIVES_IN:.3f}-{KNIVES_OUT:.3f}", flush=True)
