#!/usr/bin/env python3
"""Replace only 0:53–1:01 of Part 02 v01 with 08_drop_hits_slide v06. Keep v01 audio.

REFUSE ward / v05 wheel / any v01–v05 fail plate.
"""
...
OUT = PROJ / "09_Final-Export/hos_001_part02_rough_v06.mp4"
T0, T1 = 53.0, 61.0
REFUSED = (
    "08_ward_vs_lens",
    "ward_vs_lens",
...
def main() -> None:
    ...
    if any(x in blob for x in REFUSED) or "ward" in PLATE.name.lower():
        raise SystemExit(f"REFUSED: will not splice a v01–v05 fail plate ({PLATE})")
    if PLATE.parent.name != "v06_flow":
        raise SystemExit(f"REFUSED: plate must live in v06_flow, got {PLATE.parent}")
