#!/usr/bin/env python3
"""Part 04 v21 rough — Proof in a Flask.

Flask-identity recut. Parent v20 stays. Do not overwrite v20.
04/10 edit-first locked Pasteur. 08 Fast T2V hitchhikers. KEEP 07 bloom.
"""
...
OUT = PROJ / "09_Final-Export/hos_001_part04_rough_v21.mp4"
CLIP_LOCK = {
    ...
    "08_passengers": "08_passengers_v21.mp4",
...
def main() -> None:
    ...
    for p in plates:
        ...
        if not name:
            raise SystemExit(f"STOP: no v21 lock for {p['id']}")
        cand = RAW / name
        clips.append(cand)
