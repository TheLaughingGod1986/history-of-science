#!/usr/bin/env python3
"""Part 04 v22 rough — Proof in a Flask.

08 passengers recut. Parent v21 stays. Do not overwrite v21.
One Pasteur world — no other flask shapes, no cartoon germ sprites.
"""
...
OUT = PROJ / "09_Final-Export/hos_001_part04_rough_v22.mp4"
CLIP_LOCK = {
    ...
    "08_passengers": "08_passengers_v22.mp4",
...
def main() -> None:
    ...
    for p in plates:
        ...
        if not name:
            raise SystemExit(f"STOP: no v22 lock for {p['id']}")
        cand = RAW / name
        clips.append(cand)
