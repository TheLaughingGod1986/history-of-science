...
Hard-refuse splicing rejected v02/v03 ward plates.
"""
...
PLATE = PROJ / "04_Generated-Clips/part02/raw/v04_api/08_ward_vs_lens_v04.mp4"
...
def main() -> None:
    ...
    if src is None:
        raise SystemExit("missing v01 rough — download hos-001-uat-cuts release")
    if not PLATE.exists():
        raise SystemExit(f"missing plate {PLATE} — mint + visual-QA first")
    for reject in REJECT_PLATES:
