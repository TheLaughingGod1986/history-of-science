#!/usr/bin/env python3
"""Part 04 v11 rough — Proof in a Flask.

Prefer 07_bloom_cloud_v11 then v10. KEEP rest of v10 plates.
...
OUT = PROJ / "09_Final-Export/hos_001_part04_rough_v11.mp4"
ICLOUD = Path(
...
def main() -> None:
    ...
    for p in plates:
        chosen = None
        for ver in ("v11", "v10", "v09", "v08", "v07", "v06", "v05", "v04", "v03", "v02"):
