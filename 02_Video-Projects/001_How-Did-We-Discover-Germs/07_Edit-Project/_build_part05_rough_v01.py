#!/usr/bin/env python3
"""Part 05 v01 rough — Clean Hands, Clean Cuts.
...
OUT = PROJ / "09_Final-Export/hos_001_part05_rough_v01.mp4"
...
CLIP_LOCK = {
    ...
    "04_explorer_scrubs": "04_explorer_scrubs_v01.mp4",
    "05_theatre_wins": "05_theatre_wins_v01d.mp4",
    "06_soap_hands": "06_soap_hands_v01.mp4",
...
def main() -> None:
    ...
    for p in plates:
        ...
        if not name:
            raise SystemExit(f"STOP: no v01 lock for {p['id']}")
        cand = RAW / name
        clips.append(cand)
