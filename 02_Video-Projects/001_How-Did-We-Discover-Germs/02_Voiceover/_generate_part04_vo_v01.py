#!/usr/bin/env python3
"""Part 04 VO — Proof in a Flask. Ben Orbit Narrator only. Do not print the API key."""
...
PROJ = HERE.parent
TXT = HERE / "part04_proof_in_a_flask_v01.txt"
MP3 = HERE / "part04_proof_in_a_flask_v01.mp3"
WAV = HERE / "part04_proof_in_a_flask_v01.wav"
ALIGN = HERE / "part04_proof_in_a_flask_v01_align.json"
...
def main() -> None:
    ...
    for label, needle in [
        ("PASTEUR", "pasteur"),
        ("SWAN NECK", "swan neck"),
        ("STILL CLEAR", "stays clear"),
        ("THE BREACH", "one breach"),
