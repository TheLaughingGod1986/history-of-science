#!/usr/bin/env python3
"""HOS 003 Part 03 rough v02 — v01 plate set EXCEPT 07→v03 helix remint + VO v02 + ominous bed.
...
OUT = PROJ / "09_Final-Export/hos_003_part03_rough_v02.mp4"
ICLOUD = (
    Path.home()
    / "Library/Mobile Documents/com~apple~CloudDocs/HOS UAT"
    / "hos_003_part03_rough_v02.mp4"
)
WORK = PROJ / "07_Edit-Project/_part03_v02_work"
LABEL_DIR = PROJ / "07_Edit-Project/_part03_v02_labels"
META = PROJ / "07_Edit-Project/part03_rough_v02_land_meta.json"
...
PLATE_SHA = {
    ...
    "07_explorer_hand_beam_v03.mp4": "7d4d70ee8aeeb3f450f368c143b4feeb804e0739b83ec9272b752397876aa4f0",
...
def _assert_assets() -> None:
    ...
    # Explorer only on 07
    for name in PLATES:
        if "explorer" in name.lower() and name != "07_explorer_hand_beam_v03.mp4":
...
def write_land(
    ...
    payload = {
        ...
        "status": "LANDED",
        "reason": "Part 03 rough v02 — same v01 plate set except 07 reminted to v03 (helix HARD FAIL wipe)",
        "output_path": str(OUT),
        "sha256": digest,
        "duration_s": dur,
