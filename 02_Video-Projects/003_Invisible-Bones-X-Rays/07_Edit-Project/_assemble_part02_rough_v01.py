...
OUT = PROJ / "09_Final-Export/hos_003_part02_rough_v01.mp4"
ICLOUD = (
    Path.home()
    / "Library/Mobile Documents/com~apple~CloudDocs/HOS UAT"
    / "hos_003_part02_rough_v01.mp4"
)
WORK = PROJ / "07_Edit-Project/_part02_v01_work"
LABEL_DIR = PROJ / "07_Edit-Project/_part02_v01_labels"
META = PROJ / "07_Edit-Project/part02_rough_v01_land_meta.json"
XFADE = 0.35
CLIP_USE = 8.0
BED_VOL = 0.34
FPS = 24
...
def cue_from_align(
    ...
    """Side labels + teach cards timed to spoken terms; snap late cues onto plates."""
    fallback_labels = [
    ...
    for start, dur, name in raw:
        if start >= pic_dur - 0.4:
            # Snap late spoken terms onto the plate that owns that beat.
            snap = {
...
def main() -> None:
    ...
    meta = {
        ...
        "house": "No Explorer. No Orbit. Flat-cardboard brief. Continuous 1x motion.",
    }
