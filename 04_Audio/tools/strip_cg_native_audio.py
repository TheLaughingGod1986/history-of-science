#!/usr/bin/env python3
"""Strip baked-in Veo/Omni speech from downloaded CG clips (keep picture only).

Channel VO is British Ben Orbit Narrator mixed in edit — never keep model speech.
