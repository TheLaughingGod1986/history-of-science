...
### A — arrive at golden mirrors (8–10s)

--- PROMPT ---

Premium cinematic 3D animation, educational space documentary. Soft warm key light on Orbit, cool scientific accents, shallow depth of field, continuous subtle hover. Full character motion — not a still with light wiggle. SILENT PICTURE ONLY: no dialogue, no narration, no voiceover, no spoken words, no lip-sync speech, no American or any-language talking. Ambient space only if audio is required; otherwise mute. Channel VO is British Ben Orbit Narrator mixed in edit.

James Webb Space Telescope in L2 sunlight. Huge golden hexagonal mirror array dominating frame. Orbit arrives carefully near the sunshield edge, tiny against honeycomb mirrors. Soft warm key on Orbit, cool engineering reflections. Continuous hover.
...
### B — silhouette against honeycomb (8–10s)

--- PROMPT ---

Premium cinematic 3D animation, educational space documentary. Soft warm key light on Orbit, cool scientific accents, shallow depth of field, continuous subtle hover. Full character motion — not a still with light wiggle. SILENT PICTURE ONLY: no dialogue, no narration, no voiceover, no spoken words, no lip-sync speech, no American or any-language talking. Ambient space only if audio is required; otherwise mute. Channel VO is British Ben Orbit Narrator mixed in edit.

Orbit silhouetted against JWST golden hexagons. Reaches toward (but never touches) a mirror segment. Cream eyes awe. Camera slow orbit revealing mirror scale. Photoreal-cinematic telescope, Pixar-warm Orbit.
...
### C — track infrared ghost (8–10s)

--- PROMPT ---

Premium cinematic 3D animation, educational space documentary. Soft warm key light on Orbit, cool scientific accents, shallow depth of field, continuous subtle hover. Full character motion — not a still with light wiggle. SILENT PICTURE ONLY: no dialogue, no narration, no voiceover, no spoken words, no lip-sync speech, no American or any-language talking. Ambient space only if audio is required; otherwise mute. Channel VO is British Ben Orbit Narrator mixed in edit.

Orbit tilts, cream eyes tracking a faint infrared ghost of a distant early galaxy forming beyond the mirrors. Subtle shimmer suggesting invisible infrared. JWST readable; Orbit readable; no UI text.
