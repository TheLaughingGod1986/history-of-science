...
**Cite / scope:** Locked from Ben’s 9 Sep override stills on P04 Empty Chairs **v17**. These ALWAYS fails / clarifications apply **standing ALWAYS to every HOS cut thereafter** — not P04-only. Remint is already running elsewhere; do **not** launch remint, mint, or Mini work from encoding this lock.  
...
Score every rough / lock / ship gate against **all eight**. Fail any → **UAT FAIL** (stills when picture fails; **late-shot ghost fails also require continuous-playback evidence** — scrub the late window, do not clear from one frame alone).
...
| Explorer / Part 01 style / microbe locks | **Consistency** + **Explorer round glasses** + **Explorer face/hair** score those house rules on every cut. Do not weaken them. |
...
- Cite this bible + the Cursor rule when failing a cut for consistency, VO-visual miss, missing glasses, lamp flame / smoke artifacts, lamp lava drip, blank or garbled cards, unfinished Explorer hair, face-cloud blot, black-hole scalp dots, soft/unfinished late shots, or late-shot horizontal ghosts (with continuous-playback evidence).
...
- Soft-pass off-model Explorer, bare/no-glasses Explorer, unfinished Explorer hair / bald crown, face-cloud blot, black-hole scalp dots, flame-spit / smoke lamps, lamp lava drip, blank or garbled hero cards, scenery-only under specific VO, soft/ghosted/unfinished late shots, or horizontal ghost / double-exposure on lamp / flasks / grid scored from one still only
